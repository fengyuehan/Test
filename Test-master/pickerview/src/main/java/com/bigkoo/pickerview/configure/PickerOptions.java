...
public class PickerOptions {
    ...
    public OnCustomTimeSelectListener mOnCustomTimeSelectListener;
    ...
    public String label_year, label_month, label_day, label_another_year, label_another_month, label_another_day;//单位
    public int x_offset_year, x_offset_month, x_offset_day, x_offset_another_year, x_offset_another_month, x_offset_another_day;//单位
