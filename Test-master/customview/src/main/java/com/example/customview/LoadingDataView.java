...
public class LoadingDataView extends View {
    ...
    //线条最大长度
    private final int MAX_LINE_LENGTH = dp2px(getContext(), 60);
    //线条最短长度
    ...
    public LoadingDataView(Context context, AttributeSet attrs, int defStyleAttr) {
