...
public class ApplicationParserUtil {
    public static ApplicationInfo generateApplicationInfo(File apkFile) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, InstantiationException, ClassNotFoundException, IOException {
