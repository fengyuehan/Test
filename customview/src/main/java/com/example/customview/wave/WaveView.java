...
public class WaveView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mSecondPath.rewind();
        mCenterPath.rewind();
        mFirstPath.lineTo(0,mCenterHeight);
        mSecondPath.lineTo(0,mCenterHeight);
        mCenterPath.lineTo(0,mCenterHeight);
        ...
        for (int i = 0; i <= SAMPLE_SIZE; i++){
            ...
            float y1 = i < SAMPLE_SIZE? (float) (mAmplitude * calcValue(mapX[i], offset)) :0;
