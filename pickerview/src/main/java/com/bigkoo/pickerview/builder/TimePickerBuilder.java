...
public class TimePickerBuilder {
    ...
    //Required
    public TimePickerBuilder(Context context, OnCustomTimeSelectListener listener) {
        mPickerOptions = new PickerOptions(PickerOptions.TYPE_PICKER_TIME);
        mPickerOptions.context = context;
        mPickerOptions.mOnCustomTimeSelectListener = listener;
    }
    ...
    public TimePickerBuilder setLabel(String label_year, String label_month, String label_day, String label_another_year, String label_another_month, String label_another_day) {
        mPickerOptions.label_year = label_year;
        mPickerOptions.label_month = label_month;
        mPickerOptions.label_day = label_day;
        mPickerOptions.label_another_year = label_another_year;
        mPickerOptions.label_another_month = label_another_month;
        mPickerOptions.label_another_day = label_another_day;
        return this;
    }
     ...
     * @param x_offset_another_year   时
     * @param x_offset_another_month 分
     * @param x_offset_another_day 秒
     * @return
     */
    public TimePickerBuilder setTextXOffset(int x_offset_year, int x_offset_month, int x_offset_day,
                                            int x_offset_another_year, int x_offset_another_month, int x_offset_another_day) {
        ...
        mPickerOptions.x_offset_another_year = x_offset_another_year;
        mPickerOptions.x_offset_another_month = x_offset_another_month;
        mPickerOptions.x_offset_another_day = x_offset_another_day;
        return this;
    }
